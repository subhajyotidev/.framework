# Yes, this is the templating engine that holds it all together!
# The code is hopefully self-explanatory, so dive right in!
# Use a tree-sitter enable editor like helix to get syntax-highlighting inside the
# writePython3Bin string.
{
  perSystem =
    { pkgs, ... }:
    let
